...
Final unit (U4) of the [SM8550 substrate capability boundary refactor plan](../docs/plans/2026-05-29-002-refactor-sm8550-substrate-capability-boundary-plan.md). Intentionally deferred from the first nix-on-rocks PR ([simonwjackson/nix-on-rocks#2](https://github.com/simonwjackson/nix-on-rocks/pull/2), merged) because the plan orders U4 *after* U5 — removing the module before Korri trunk stops setting `rocknix.sm8550.moonlight.*` would break Korri eval.
...
- `docs/plans/2026-05-29-002-refactor-sm8550-substrate-capability-boundary-plan.md`
