...
**Approach:**
- Add a leading comment block: "This file is intentionally not batched. Both tests do fundamentally different work (one dry-builds the ISO derivation, one is a documentation smoke). Batching would conflate them for no time savings. See ./plan.md U7."
...
- Related plan (just completed, same atomic-commit + TDD cadence): `../01KSBMG31RB7XVW5JMYM46BAXR-refactor-renderer-bun-boundary/plan.md`.
