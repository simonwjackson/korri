...
- **Origin document:** `../../01KSBMG31W82JBVJBJ5TT15MZN-feat-default-gamescope-foreground-launch/requirements.md` (F4, R14, R17, R18–R20)
- **Antecedent plan:** `../01KSKBP82HQFQW9T76W9CQJYF0-feat-foreground-session-source-machine-phase4c/plan.md` (completed) — Track A is its explicit deferred follow-up.
- **Phase 4A plan:** `../01KSGS9H2ETAC371KG4XMD16K3-feat-foreground-session-adapter-rollout/plan.md`
- **Phase 4B plan:** `../01KSGS9H2F79GQCPRE18HVNACE-feat-sessiond-managed-lifecycle-events/plan.md`
