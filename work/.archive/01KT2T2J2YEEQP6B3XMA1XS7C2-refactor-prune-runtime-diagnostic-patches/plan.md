...
- `../../parking-lot/01KT2T2J1DZS406XDGSESZ6568-consolidate-runtime-resolution-sunshine-patches`: consolidate the surviving Sunshine runtime-resolution mechanism patches once the diagnostic patches are gone.
- `../../parking-lot/01KT2T2J1E9FF73YC0ESAM18F8-right-size-runtime-resolution-idr-recovery-window`: right-size the surviving Sunshine fresh-IDR window in `0010` after this cleanup lands.
- `../../parking-lot/01KT2T2J1RYZ3J55P3CJHVNAHD-consolidate-runtime-resolution-moonlight-patches`: consolidate the surviving Moonlight runtime-resolution patches after diagnostic pruning.
- `../../parking-lot/01KT2T2J26C70G937KW2VE7HMA-fix-bandai-gamescope-acceptance-harness-command-ordering-and`: fix the Bandai Gamescope acceptance harness command ordering and capture settle behavior before relying on it for unattended future gates.
...
- Exact Bandai command invocation while `task-111` is open: use the known corrected ordering and settle behavior from `../../parking-lot/01KT2T2J26C70G937KW2VE7HMA-fix-bandai-gamescope-acceptance-harness-command-ordering-and`, but allow the implementer to adapt to the current bridge CLI.
...
- Any harness workaround is documented as an interim validation note tied to `../../parking-lot/01KT2T2J26C70G937KW2VE7HMA-fix-bandai-gamescope-acceptance-harness-command-ordering-and`.
...
- Backlog origin: `../../parking-lot/01KT2T2J1CB16BGMV4RSV8VC4S-prune-obsolete-live-resolution-diagnostic-patches.md`
- Related blocker: `../../parking-lot/01KT2T2J26C70G937KW2VE7HMA-fix-bandai-gamescope-acceptance-harness-command-ordering-and.md`
