...
Extend the `TilegridRailRoot` primitive so a single horizontal rail can carry **heterogeneous-width tiles at a uniform row height**: one wide landscape "feature" tile (≈16:9) sitting alongside several portrait 2:3 cover posters, all scrolling together as one row. This unblocks the Switch-style hero rail explored in the home-screen visual-language brainstorm (see origin: `../../01KQDTYV32N1ERDVDGHCBZN6MY-shift-home-screen-visual-language/requirements.md`, R7–R8).
...
- The new Storybook story is the load-bearing acceptance demonstration for the home-screen visual-language exploration that motivated this work (see origin: `../../01KQDTYV32N1ERDVDGHCBZN6MY-shift-home-screen-visual-language/requirements.md`, R7–R8).
- After merge, `../../01KQDTYV32N1ERDVDGHCBZN6MY-shift-home-screen-visual-language/requirements.md` follow-up planning can use the heterogeneous rail capability to build the Hero variant's rail-drives-hero focus model (R8) without further primitive changes.

## Sources & References

- **Origin document:** [`../../01KQDTYV32N1ERDVDGHCBZN6MY-shift-home-screen-visual-language/requirements.md`](../../01KQDTYV32N1ERDVDGHCBZN6MY-shift-home-screen-visual-language/requirements.md) (R7, R8).
...
- Related plan: `../01KQDTYV09D7NMQE79KJGS1Q5X-feat-tilegrid-css-length-cellsize/plan.md` (introduced the `useResolvedCSSLength` mechanism this plan reuses).
