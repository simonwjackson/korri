...
- Related prior plan: `../01KS1AX71BKAHX0WAFMBMP1HTW-refactor-desktop-as-server-client/plan.md` (introduced the `window.__korriConnection` preload bridge precedent this plan extends).
