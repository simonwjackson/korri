...
- `../../01KS6FPN1HVWGZGE4HCC8GDX6Q-refactor-korri-dependency-inversion/requirements.md` defines the ownership rule: Korri is the product/appliance layer; nix-on-rocks is the substrate.
- `../../01KS6FPN1HVWGZGE4HCC8GDX6Q-refactor-korri-dependency-inversion/plan.md` established that explicit per-device RockNix outputs are the build/review gates and `by-compatible` is impure on-device convenience.
- `../01KSE6WT21R96831J68YFWNM4K-refactor-native-nix-test-boundary/plan.md` moved Nix assertions into native Nix checks; payload validation should follow that boundary instead of routing Nix facts through Bun.
...
- Reference: `../../01KS6FPN1HVWGZGE4HCC8GDX6Q-refactor-korri-dependency-inversion/plan.md`
...
- Related Korri plan: [../../01KS6FPN1HVWGZGE4HCC8GDX6Q-refactor-korri-dependency-inversion/plan.md](../../01KS6FPN1HVWGZGE4HCC8GDX6Q-refactor-korri-dependency-inversion/plan.md)
- Related Korri docs: [docs/deployment/korri-images.md](../../../docs/deployment/korri-images.md)
