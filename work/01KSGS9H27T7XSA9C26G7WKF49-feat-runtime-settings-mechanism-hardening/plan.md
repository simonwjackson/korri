...
- No new Moonlight local IPC transport design, TypeScript protocol schema, local control client, or IPC event semantics; `../01KSGS9H268R0NGRBZ65PWDXNJ-feat-moonlight-local-control-protocol/plan.md` owns that work.
...
- `../01KSE6WT20F2EP92EABSNSDK11-feat-moonlight-live-settings-validation-spike/requirements.md` identifies the active control stream as the safest live-settings extension seam.
- `../01KSGS9H268R0NGRBZ65PWDXNJ-feat-moonlight-local-control-protocol/plan.md` defines the separate local observability/IPC work that should consume these hardened mechanisms.
...
- Should this duplicate the local IPC/observability work? No. The local socket, schemas, and generic event stream are owned by `../01KSGS9H268R0NGRBZ65PWDXNJ-feat-moonlight-local-control-protocol/plan.md`.
...
- Command response boundary described by `../01KSGS9H268R0NGRBZ65PWDXNJ-feat-moonlight-local-control-protocol/plan.md`
...
- Related source: `../01KSE6WT20F2EP92EABSNSDK11-feat-moonlight-live-settings-validation-spike/requirements.md`
