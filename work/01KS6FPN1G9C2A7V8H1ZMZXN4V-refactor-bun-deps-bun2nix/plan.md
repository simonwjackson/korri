...
- `../.archive/01KQDTYV07RF4XA01AVGR2DBCN-feat-electrobun-nix-native-build/plan.md` — origin plan that introduced the FOD pattern; this plan supersedes that decision now that operational pain has surfaced.
...
- Related prior plan: `../.archive/01KQDTYV07RF4XA01AVGR2DBCN-feat-electrobun-nix-native-build/plan.md` (introduced the FOD pattern this plan supersedes)
