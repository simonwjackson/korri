...
- **Interaction with the in-flight pointer-aware spatial navigation work** (`../01KQGDBJ0CPYZHWA7XQ77VND6P-feat-pointer-aware-spatial-navigation/requirements.md`). Hover-driven focus should use the same Mario-camera scroll path as directional focus; verify ordering between the two brainstorms during planning.
