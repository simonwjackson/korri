...
- **Origin document:** [docs/briefs/2026-05-25-korri-nixos-module-boundary-brief.md](../../docs/briefs/2026-05-25-korri-nixos-module-boundary-brief.md)
- Related code:
...
- Related institutional learnings:
  ...
  - `docs/solutions/workflow-issues/generic-game-stream-runner-validation-contract-2026-05-19.md`
- Related prior plans:
  - `../.archive/01KS1AX7198H2674KGB9QM63JR-refactor-korri-server-control-plane/plan.md`
  - `../.archive/01KS1AX71AS00C6ESAPRYHBKG3-refactor-korri-server-system-service/plan.md`
