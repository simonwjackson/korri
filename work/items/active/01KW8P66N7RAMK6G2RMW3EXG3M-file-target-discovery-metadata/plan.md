...
status: active
date: 2026-06-29
verify_command: "bun test product/platform/library/config/records/library-item.test.ts product/platform/library/config/records/readable-schema.test.ts product/platform/library/discovery/release-candidate-scan.test.ts product/platform/library/proseql/library-repository.test.ts product/surfaces/terminal/korri-cli/korri-cli.test.ts && bunx biome check product/platform/library/config/records/library-item.ts product/platform/library/config/records/library-item.test.ts product/platform/library/config/records/readable-schema.test.ts product/platform/library/discovery/rom-scan-classifier.ts product/platform/library/discovery/release-candidate-scan.ts product/platform/library/discovery/release-candidate-scan.test.ts product/platform/library/proseql/library-repository.ts product/platform/library/proseql/library-repository.test.ts product/surfaces/terminal/korri-cli/scout-command.ts product/surfaces/terminal/korri-cli/korri-cli.test.ts"
---
