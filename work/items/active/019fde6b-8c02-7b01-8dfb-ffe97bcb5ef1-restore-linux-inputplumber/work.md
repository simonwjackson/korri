...
1. Verify the Korri worktree is clean at the final documentation commit above code revision `6f34f1fddee0d5b0eb75e819ed218a4b694b566e`. Verify Mountainous still pins the exact local Korri revision at `e3f988e`. Preserve and reconcile the unrelated `features/disk-array/nixos.nix` work separately; do not include it in this rollout.
...
4. Use candidate `/nix/store/2fbh1np1anck1y26b04v134rl0chk9m2-nixos-system-zao-26.05.20260313.c06b4ae`. Use confirmation `CONFIRM-327cb0b1d038edd3`; do not reuse any older candidate token.
