...
- [ ] Document whether Steam/Proton/FEX Windows titles on SM8550 benefit from x86_64 Mesa 26 versus the current Arch rootfs Mesa 25.3.3
- [ ] If needed, provide a durable Steam-scoped Mesa 26 x86_64 Freedreno route without overwriting guest rootfs libraries with aarch64 host libraries
- [ ] Verify 30XX still launches, maps libvulkan_freedreno.so, opens /dev/dri/renderD128, and remains playable after the change
