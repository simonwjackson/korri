...
- `../.archive/01KSGS9H2F79GQCPRE18HVNACE-feat-sessiond-managed-lifecycle-events/plan.md` — Phase 4B established `app.server.status` as the proxy and explicitly stated sessiond is not a renderer-facing protocol.
...
- **Predecessor plans (all completed):**
  - [../.archive/01KSGS9H29WESM50SDTRMQVWW8-feat-foreground-session-lifecycle-phase1/plan.md](../.archive/01KSGS9H29WESM50SDTRMQVWW8-feat-foreground-session-lifecycle-phase1/plan.md) — generic owner contract
  - [../.archive/01KSGS9H2F79GQCPRE18HVNACE-feat-sessiond-managed-lifecycle-events/plan.md](../.archive/01KSGS9H2F79GQCPRE18HVNACE-feat-sessiond-managed-lifecycle-events/plan.md) — sessiond as managed launcher adapter, `app.server.status` proxy decision
  - [../.archive/01KSKBP82J0WJ1JWWK0XAVB6HB-feat-sessiond-session-lifecycle-unification/plan.md](../.archive/01KSKBP82J0WJ1JWWK0XAVB6HB-feat-sessiond-session-lifecycle-unification/plan.md) — lifecycle-session intent routing
