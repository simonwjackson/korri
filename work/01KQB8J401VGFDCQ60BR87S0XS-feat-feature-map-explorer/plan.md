...
- Tiptap-based rich Markdown editing for jobs/briefs shipped in follow-up plan `../.archive/01KQDTYV02PZYYTQWFXSRFANZX-feat-tiptap-markdown-editor/plan.md`; Raw remains the fallback.
