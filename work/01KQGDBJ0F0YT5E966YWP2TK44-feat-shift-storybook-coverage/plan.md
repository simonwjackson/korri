...
- Origin: this turn's user request, following the gap identified after `../01KQGDBJ0EX3F69DPBQPFWZPHT-feat-shift-atomic-theme/plan.md` shipped.
- Prior plan that established the atomic structure: `../01KQGDBJ0EX3F69DPBQPFWZPHT-feat-shift-atomic-theme/plan.md`.
- Brainstorm that drove the structural decomposition: `../01KQGDBJ0EX3F69DPBQPFWZPHT-feat-shift-atomic-theme/requirements.md`.
- Original Shift port plan that included per-level stories (referenced for shape, not executed): `../01KQB8J400TGS1KZJTDXHWY2Z3-feat-shift-theme-atomic-design/plan.md`.
