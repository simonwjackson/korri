...
date: 2026-05-03
origin:
  - ../01KQJZR90GHVYQ169G3QWN3G5T-feat-personal-mvp-rocknix-launch/requirements.md
  - ../.archive/01KQDTYV07RF4XA01AVGR2DBCN-feat-electrobun-nix-native-build/requirements.md
---
...
The personal MVP requires the full open-Korri → choose recent game → launch real game loop on the developer's Odin 2 Portal (see origin: `../01KQJZR90GHVYQ169G3QWN3G5T-feat-personal-mvp-rocknix-launch/requirements.md`). The current Odin loop runs the API on the device and the renderer on the dev machine through Vite; this proves real `runemu.sh` launches but is not the final device experience.

Separately, the Electrobun/Nix work already proves a Linux desktop package for `x86_64-linux` and `aarch64-linux` while preserving the same-origin `/api/rpc` contract (see origin: `../.archive/01KQDTYV07RF4XA01AVGR2DBCN-feat-electrobun-nix-native-build/requirements.md`). What is missing is an Odin-specific packaging and launch seam: build the aarch64 package, deploy it to ROCKNIX, run it in the handheld's Wayland session, and verify it uses the real library and launcher without changing ROCKNIX-owned files.
...
- **Origin document:** [../.archive/01KQDTYV07RF4XA01AVGR2DBCN-feat-electrobun-nix-native-build/requirements.md](../.archive/01KQDTYV07RF4XA01AVGR2DBCN-feat-electrobun-nix-native-build/requirements.md)
- Related plan: [../.archive/01KQDTYV05D4Q8T63WBQSHD6A1-feat-electrobun-desktop-wrapper/plan.md](../.archive/01KQDTYV05D4Q8T63WBQSHD6A1-feat-electrobun-desktop-wrapper/plan.md)
- Related plan: [../.archive/01KQDTYV07RF4XA01AVGR2DBCN-feat-electrobun-nix-native-build/plan.md](../.archive/01KQDTYV07RF4XA01AVGR2DBCN-feat-electrobun-nix-native-build/plan.md)
- Related plan: [../01KQJZR90GHVYQ169G3QWN3G5T-feat-personal-mvp-rocknix-launch/plan.md](../01KQJZR90GHVYQ169G3QWN3G5T-feat-personal-mvp-rocknix-launch/plan.md)
- Device context: [docs/deployment/device-report.md](../../docs/deployment/device-report.md)
