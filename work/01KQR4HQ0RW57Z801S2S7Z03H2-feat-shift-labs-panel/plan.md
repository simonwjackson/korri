...
- `../01KQGDBJ0EX3F69DPBQPFWZPHT-feat-shift-atomic-theme/requirements.md`: Shift components are organized by atomic level, with `ShiftHomeRoot` as the state owner and `ShiftHome*` prefixes for home-specific surfaces.
