...
- `../.archive/01KQNJ500NY8SY5AR3K2C23GE8-feat-native-input-bridge/requirements.md` requires the open → navigate → launch → exit → back to Korri loop to work under controller input alone.
- `../01KQNJ500HSCEXXJ56C0CG3858-feat-odin-electrobun-build/plan.md` captured the reversible runtime-mask approach for `essway.service`, but runtime testing showed the Electrobun/WebKit path is not the right GPU baseline.
...
- Related requirements: `../.archive/01KQNJ500NY8SY5AR3K2C23GE8-feat-native-input-bridge/requirements.md`
- Related plan: `../01KQNJ500HSCEXXJ56C0CG3858-feat-odin-electrobun-build/plan.md`
