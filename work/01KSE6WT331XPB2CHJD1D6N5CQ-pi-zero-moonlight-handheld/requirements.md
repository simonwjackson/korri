...
- `../01KRW63S14EZX008ANYWY3P8Z1-feat-headless-game-stream-runner/requirements.md` — adjacent: orchestration on the server side; this brainstorm is about the client device
