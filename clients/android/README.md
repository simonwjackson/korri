...
32. [Intent-based launch](USAGE.md) with custom resolution, FPS, bitrate, frame pacing, ultra low latency, video scale mode, codec, and display positioning via ADB, deep links (`art://`), or `.art` files
