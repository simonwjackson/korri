...
public class KeyBoardControllerConfigurationLoader {
    public static final String KEYBOARD_LAYOUT_PREFERENCE = "keyboard_axi_list";
    public static final String DEFAULT_KEYBOARD_LAYOUT = "OSC_Keyboard";
    public static final String SPECIAL_KEYS_PREF_NAME = "specialPrefs";
    public static final String SPECIAL_KEYS_PREF_KEY = "special_key";
    ...
    public static void createDefaultLayout(final KeyBoardController controller, final Context context, final NvConnection conn) {
        ...
        try {
            ...
            for (int i = 0; i < rockerList.length(); i++) {
                ...
                if (config.enableNewKeyboardAnalogStick) {
            ...
            // Custom keys
            SharedPreferences preferences = context.getSharedPreferences(SPECIAL_KEYS_PREF_NAME, Activity.MODE_PRIVATE);
            String value = preferences.getString(SPECIAL_KEYS_PREF_KEY, "");
        ...
        controller.setOpacity(config.keyboardOpacity);
    }

    public static void saveProfile(final KeyBoardController controller,
                                   final Context context) {
        String name = PreferenceManager.getDefaultSharedPreferences(context).getString(KEYBOARD_LAYOUT_PREFERENCE, DEFAULT_KEYBOARD_LAYOUT);
