...
public class KeyBoardController {
    ...
    private static final void _DBG(String text) {
        if (_PRINT_DEBUG_INFORMATION) {
            LimeLog.info("KeyboardController: " + text);
        }
    }
    ...
    private void showKeySelectionDialog() {
        try {
            ...
            android.content.SharedPreferences preferences = context.getSharedPreferences(KeyBoardControllerConfigurationLoader.SPECIAL_KEYS_PREF_NAME, Context.MODE_PRIVATE);
            String value = preferences.getString(KeyBoardControllerConfigurationLoader.SPECIAL_KEYS_PREF_KEY, "");
