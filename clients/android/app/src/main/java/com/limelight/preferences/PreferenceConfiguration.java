...
//    static final String TOUCHSCREEN_TRACKPAD_PREF_STRING = "checkbox_touchscreen_trackpad";
    ...
    private static final String KEYBOARD_OPACITY_PREF_STRING = "seekbar_keyboard_axi_opacity";
    private static final String LEGACY_OSC_OPACITY_PREF_STRING = "seekbar_osc_opacity";
    ...
    //自动摇杆
    private static final String ENABLE_KEYBOARD_ANALOG_STICK_STRING = "checkbox_enable_analog_stick_new";
...
//    public String customBitrate;
    ...
    public boolean enforceDisplayMode, enableSops, playHostAudio, disableWarnings, fullScreen;
    ...
    //自由摇杆啊
    public boolean enableNewKeyboardAnalogStick;
...
private static int getFramePacingValue(Context context) {
    ...
    static void migrateLegacyKeyboardOpacity(SharedPreferences basePrefs) {
        if (basePrefs.contains(LEGACY_OSC_OPACITY_PREF_STRING)) {
            SharedPreferences.Editor editor = basePrefs.edit();
            if (!basePrefs.contains(KEYBOARD_OPACITY_PREF_STRING)) {
                editor.putInt(KEYBOARD_OPACITY_PREF_STRING,
                        basePrefs.getInt(LEGACY_OSC_OPACITY_PREF_STRING, DEFAULT_OPACITY));
            }
            editor.remove(LEGACY_OSC_OPACITY_PREF_STRING).apply();
        }
    }
    ...
    static int resolveKeyboardOpacity(SharedPreferences prefs) {
        ...
        return prefs.getInt(KEYBOARD_OPACITY_PREF_STRING, DEFAULT_OPACITY);
    }
...
//        config.touchscreenTrackpad = prefs.getBoolean(TOUCHSCREEN_TRACKPAD_PREF_STRING, DEFAULT_TOUCHSCREEN_TRACKPAD);
        ...
        //全键盘透明度
        config.keyboardOpacity = resolveKeyboardOpacity(prefs);
        ...
        config.enableNewKeyboardAnalogStick = prefs.getBoolean(ENABLE_KEYBOARD_ANALOG_STICK_STRING, false);
...
//        config.customBitrate = prefs.getString(CUSTOM_BITRATE_PREF_STRING, null);
        ...
        // (reference default 8).
        config.sgsrSharpness = prefs.getInt(SGSR_SHARPNESS, 20) / 10f;
        config.sgsrEdgeThreshold = prefs.getInt(SGSR_EDGE_THRESHOLD, 8) / 255f;
