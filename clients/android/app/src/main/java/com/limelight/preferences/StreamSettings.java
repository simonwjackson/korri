...
//        UiHelper.notifyNewRootView(this);
    ...
    public static class SettingsFragment extends PreferenceFragmentCompat {
        ...
        public void initializePreferences() {
            ...
            // Hide virtual-key controls on non-touchscreen devices
            if (!pm.hasSystemFeature(PackageManager.FEATURE_TOUCHSCREEN)) {
                PreferenceCategory category = findPreference("category_special_key_layout");
                if (category != null) {
        ...
        public void onActivityResult(int requestCode, int resultCode, Intent data) {
            ...
            if (requestCode == READ_REQUEST_CODE && resultCode == Activity.RESULT_OK && data.getData() != null) {
                try {
                    ...
                    String name = getPrefs().getString(KeyBoardControllerConfigurationLoader.KEYBOARD_LAYOUT_PREFERENCE, KeyBoardControllerConfigurationLoader.DEFAULT_KEYBOARD_LAYOUT);
            ...
            if (requestCode == READ_REQUEST_SPECIAL_CODE && resultCode == Activity.RESULT_OK && data.getData() != null) {
                try {
                    ...
                    SharedPreferences.Editor prefEditor = getActivity().getSharedPreferences(KeyBoardControllerConfigurationLoader.SPECIAL_KEYS_PREF_NAME, Activity.MODE_PRIVATE).edit();
                    prefEditor.putString(KeyBoardControllerConfigurationLoader.SPECIAL_KEYS_PREF_KEY, json);
                    prefEditor.apply();
                    Toast.makeText(getActivity(), getString(R.string.pref_import_success), Toast.LENGTH_SHORT).show();
                } catch (Exception e) {
                    e.printStackTrace();
