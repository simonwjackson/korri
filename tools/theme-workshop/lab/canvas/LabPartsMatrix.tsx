...
/** Legacy cross-product matrix for discovered (non-screen) parts: lay out
 * parts × sources × states × devices using static seeded previews. */
export function LabPartsMatrix({
  selectedStories,
  stories,
  sources,
  states,
