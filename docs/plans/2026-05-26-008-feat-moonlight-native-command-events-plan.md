...
- `docs/brainstorms/2026-05-26-001-korri-runtime-change-watch-tool-requirements.md` defines the attach-only one-change watch flow, artifact requirement, terminal outcome vocabulary, and no-overclaiming boundary.
- `docs/plans/2026-05-26-003-feat-moonlight-local-control-protocol-plan.md` defines the generic Moonlight local IPC protocol and explicitly separates local command acceptance from later host-applied outcomes.
- `docs/plans/2026-05-26-005-feat-runtime-change-watch-tool-plan.md` defines the runtime-watch CLI/client/artifact slice that is now waiting on native mutation events for live success claims.
...
- Related plan: [docs/plans/2026-05-26-004-feat-runtime-settings-mechanism-hardening-plan.md](2026-05-26-004-feat-runtime-settings-mechanism-hardening-plan.md)
- Related plan: [docs/plans/2026-05-26-005-feat-runtime-change-watch-tool-plan.md](2026-05-26-005-feat-runtime-change-watch-tool-plan.md)
