...
status: active
date: 2026-05-26
origin: docs/brainstorms/2026-05-26-001-korri-runtime-change-watch-tool-requirements.md
---
...
- `docs/brainstorms/2026-05-26-001-korri-runtime-change-watch-tool-requirements.md` defines attach-only, one-scenario, bounded observation, structured artifact, and future-E2E requirements.
- `docs/plans/2026-05-26-003-feat-moonlight-local-control-protocol-plan.md` owns the Moonlight local IPC protocol, event stream, command surface, and Korri client/launcher integration.
- `docs/plans/2026-05-26-004-feat-runtime-settings-mechanism-hardening-plan.md` owns native Moonlight/Sunshine command lifecycle, capabilities, reasons, timeouts, restore baselines, and proof gates.
...
- Exact event name matching for command results: align with the final Moonlight local-control implementation from `docs/plans/2026-05-26-003-feat-moonlight-local-control-protocol-plan.md`.
...
- `korri/shared/stream/moonlight-control-client.test.ts`
- `docs/brainstorms/2026-05-26-001-korri-runtime-change-watch-tool-requirements.md`
...
| Risk | Mitigation |
|------|------------|
| Native local-control command dispatch is not ready when this plan is implemented | Implement schema/client/runner tests against controlled socket servers first; live mutation scenarios depend on `docs/plans/2026-05-26-003-feat-moonlight-local-control-protocol-plan.md` and `docs/plans/2026-05-26-004-feat-runtime-settings-mechanism-hardening-plan.md`. |
...
- **Origin document:** [docs/brainstorms/2026-05-26-001-korri-runtime-change-watch-tool-requirements.md](../brainstorms/2026-05-26-001-korri-runtime-change-watch-tool-requirements.md)
- Related plan: `docs/plans/2026-05-26-003-feat-moonlight-local-control-protocol-plan.md`
- Related plan: `docs/plans/2026-05-26-004-feat-runtime-settings-mechanism-hardening-plan.md`
