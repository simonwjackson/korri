...
status: active
date: 2026-05-19
origin: docs/brainstorms/2026-05-19-korri-cli-stream-launch-requirements.md
---
...
- Modify: `docs/brainstorms/2026-05-19-korri-cli-stream-launch-requirements.md` only if implementation uncovers a product-scope correction that should be reflected upstream
...
- **Origin document:** [docs/brainstorms/2026-05-19-korri-cli-stream-launch-requirements.md](../brainstorms/2026-05-19-korri-cli-stream-launch-requirements.md)
