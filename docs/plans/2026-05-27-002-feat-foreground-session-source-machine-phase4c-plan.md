...
The Phase 4A roadmap (see origin: `docs/plans/2026-05-26-011-feat-foreground-session-adapter-rollout-plan.md`) deferred this to follow-up work. Phase 4C is that follow-up: keep one owner per host (origin R14), keep deployment roles composable (origin R20), and apply the Phase 4B contract to source-machine hosts without redesigning it.
...
- **No `services.korri.role` enum.** Source-machine composition is already expressible via existing capability toggles; the boundary refactor (`docs/plans/2026-05-25-001-refactor-korri-nixos-module-boundary-plan.md`) explicitly rejected a role enum. Sessiond's NixOS module asserts a composable shape.
...
- **Origin document:** [docs/brainstorms/2026-05-24-002-default-gamescope-foreground-launch-policy-requirements.md](docs/brainstorms/2026-05-24-002-default-gamescope-foreground-launch-policy-requirements.md)
- Prior phase plan: [docs/plans/2026-05-26-011-feat-foreground-session-adapter-rollout-plan.md](docs/plans/2026-05-26-011-feat-foreground-session-adapter-rollout-plan.md)
- Phase 4B plan: [docs/plans/2026-05-26-012-feat-sessiond-managed-lifecycle-events-plan.md](docs/plans/2026-05-26-012-feat-sessiond-managed-lifecycle-events-plan.md)
...
- Module boundary refactor: [docs/plans/2026-05-25-001-refactor-korri-nixos-module-boundary-plan.md](docs/plans/2026-05-25-001-refactor-korri-nixos-module-boundary-plan.md)
