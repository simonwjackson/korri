...
- **Sibling plan (source-machine, completed):** [docs/plans/2026-05-27-002-feat-foreground-session-source-machine-phase4c-plan.md](2026-05-27-002-feat-foreground-session-source-machine-phase4c-plan.md) — the "kiosk role keeps today's Electrobun + essway + Korri-home behavior" line in §"Scope Boundaries" and the explicit deferral in §"Deferred to Follow-Up Work" anchor this plan as the kiosk-side completion of that work.
- **Sibling plan (lifecycle unification, completed):** [docs/plans/2026-05-27-003-feat-sessiond-session-lifecycle-unification-plan.md](2026-05-27-003-feat-sessiond-session-lifecycle-unification-plan.md)
- **Sibling plan (adapter rollout, completed):** [docs/plans/2026-05-26-011-feat-foreground-session-adapter-rollout-plan.md](2026-05-26-011-feat-foreground-session-adapter-rollout-plan.md)
- Related code:
