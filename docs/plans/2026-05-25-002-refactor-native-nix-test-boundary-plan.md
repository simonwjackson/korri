...
This plan treats `docs/plans/2026-05-24-006-refactor-nix-test-harness-plan.md` as historical context and replaces its long-term direction with the cleaner boundary the user requested.
...
- Modify: `docs/plans/2026-05-24-006-refactor-nix-test-harness-plan.md` only if a short superseded note is desired by the implementer
...
- Superseded plan: `docs/plans/2026-05-24-006-refactor-nix-test-harness-plan.md`
