...
- Korri revision: `b3b6c38078601bbe8f50a14092b5dd44f37571ec`
- Mountainous branch: `unified`
- Mountainous revision: `caf17b39fbd8a704131134e5b75ad1d061f07515`
- Zao candidate: `/nix/store/861q2knsk2whr2nhc0858bhj20sd0bzc-nixos-system-zao-26.05.20260313.c06b4ae`
- Candidate gate SHA-256: `a795f0b387343355e21441621717d4f69e95a1c2f8bb272cad61899f930873ec`
...
The candidate is copied to Zao and rooted at `/nix/var/nix/gcroots/korri-candidate-unified-caf17b3`. Read-only verification found the rollback generation still current and default, no attempt marker, an inactive lease, and zero live `korri-game-*.service` units.
...
- The unit-declared Sunshine executable must be one exact path in the `sunshine-korri` package. The gate resolves that in-package symlink and requires the running process executable to equal its canonical target.
