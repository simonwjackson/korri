...
const declaration = {
  ...
  contributes: {
    ...
    sessionControls: {
      ...
      streamBitrate: {
        order: 16,
        id: "@korri:moonlight/stream-bitrate",
        owner: { kind: "transport", id: transport },
        label: "Stream bitrate",
        interaction: { kind: "range", min: 500, max: 150000, step: 1 },
        effect: "@korri:moonlight/set-stream-bitrate-kbps",
      },
      restoreStreamBitrate: {
        order: 17,
        id: "@korri:moonlight/restore-stream-bitrate",
        owner: { kind: "transport", id: transport },
        label: "Restore stream bitrate",
        interaction: { kind: "command" },
        effect: "@korri:moonlight/restore-stream-bitrate",
      },
      streamFps: {
        order: 18,
        id: "@korri:moonlight/stream-fps",
        owner: { kind: "transport", id: transport },
        label: "Stream FPS",
        interaction: { kind: "range", min: 1, max: 240, step: 1 },
        effect: "@korri:moonlight/set-stream-fps",
      },
      restoreStreamFps: {
        order: 19,
        id: "@korri:moonlight/restore-stream-fps",
        owner: { kind: "transport", id: transport },
        label: "Restore stream FPS",
        interaction: { kind: "command" },
        effect: "@korri:moonlight/restore-stream-fps",
      },
      streamWidth: {
        order: 20,
        id: "@korri:moonlight/stream-width",
        owner: { kind: "transport", id: transport },
        label: "Stream width",
        description: "Height follows the launch aspect ratio",
        interaction: { kind: "range", min: 2, max: 8192, step: 2 },
        effect: "@korri:moonlight/set-stream-width",
      },
      restoreStreamResolution: {
        order: 21,
        id: "@korri:moonlight/restore-stream-resolution",
        owner: { kind: "transport", id: transport },
        label: "Restore stream resolution",
        interaction: { kind: "command" },
        effect: "@korri:moonlight/restore-stream-resolution",
      },
      disconnect: {
        order: 22,
