...
export async function validateYfsWebroot(
  ...
  if (!index.includes("direct-launch-pre.js"))
    throw new Error("YFS webroot index.html does not load direct-launch-pre.js")
  if (!index.includes("direct-launch.js"))
    throw new Error("YFS webroot index.html does not load direct-launch.js")
