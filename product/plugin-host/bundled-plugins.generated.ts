// Generated bundled plugin inventory.
// Do not edit plugin-host composition logic to add/remove descriptors by hand;
// regenerate this file from the product plugin catalog when adding bundled plugins.

import type { KorriPlugin } from "@platform/plugin"
import { threeDSenPlugin } from "@product/plugins/3dsen"
...
import { gmloaderPlugin } from "@product/plugins/gmloader"
...
import { retroarchPlugin } from "@product/plugins/retroarch"
import { rpcs3Plugin } from "@product/plugins/rpcs3"
import { ryubingPlugin } from "@product/plugins/ryubing"
...
import { steamPlugin } from "@product/plugins/steam"
...
import { zquestClassicPlugin } from "@product/plugins/zquest-classic"

export const bundledPluginInventory = [
  retroarchPlugin,
  rpcs3Plugin,
  gamescopePlugin,
  moonlightPlugin,
...
] as const satisfies readonly KorriPlugin[]
