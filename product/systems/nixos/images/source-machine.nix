...
let
  ...
  sourceMachineEnabledPlugins = lib.concatStringsSep "," config.services.korri.sourceMachine.enabledPlugins;
in
{
  # The headless base wires the server bits (users, federation defaults).
  imports = [ ./headless.nix ];

  options.services.korri.sourceMachine.enabledPlugins = lib.mkOption {
