...
import { korriCachePath } from "@platform/config/xdg-paths"
import {
  createCandidateCache,
  type GameAssetCandidate,
} from "@platform/library/game-assets/candidate-cache"
import { createGameAssetsRepository } from "@platform/library/game-assets/game-assets-repository"
import {
  createGameAssetsService,
  GameAssets,
  gameAssetBlobPath,
} from "@platform/library/game-assets/game-assets-service"
