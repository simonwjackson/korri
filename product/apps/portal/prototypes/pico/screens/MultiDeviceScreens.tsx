 ...
 */
import { picoHero, picoHosts, picoSeats } from "../fixtures-extra"
import {
  Badge,
  Btn,
  Card,
    ...
    <Screen className="pad-0">
      <div className="pcMd-companion">
        ...
        <div className="pcMd-companion-overlay">
          <Title size={3}>{picoHero.title}</Title>
          <div className="pcMd-companion-dev">{picoHero.developer}</div>
        </div>
      </div>
    </Screen>
  )
