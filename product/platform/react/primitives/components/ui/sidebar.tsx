import { useIsMobile } from "@platform/react/primitives/hooks/use-mobile"
...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // biome-ignore lint/suspicious/noDocumentCookie: shadcn sidebar persists collapse state
