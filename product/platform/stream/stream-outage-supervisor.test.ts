...
describe("stream outage supervisor", () => {
  it("enters hold after sustained zero throughput", () => {
    ...
    supervisor.observe(500, {
      ...base,
      bitrateDeliveryRatio: 0,
      fpsDeliveryRatio: 0,
    })
    supervisor.observe(1501, {
      ...base,
      bitrateDeliveryRatio: 0,
      fpsDeliveryRatio: 0,
    })
  ...
  it("keeps brief dips in shed instead of loss", () => {
    ...
    supervisor.observe(900, {
      ...base,
      bitrateDeliveryRatio: 0.5,
      fpsDeliveryRatio: 0.5,
    })
  ...
  it("resumes by requesting re-establish when signal returns", () => {
    ...
    supervisor.observe(0, {
      ...base,
      bitrateDeliveryRatio: 0,
      fpsDeliveryRatio: 0,
    })
    supervisor.observe(1200, {
      ...base,
      bitrateDeliveryRatio: 0,
      fpsDeliveryRatio: 0,
    })
    const action = supervisor.observe(1800, {
      ...base,
      bitrateDeliveryRatio: 0.8,
      fpsDeliveryRatio: 0.8,
    })
