...
- Use `korrid_find_game` to resolve ambiguous user-provided ids/titles before mutating operations.
- Use `korrid_dry_run_launch` when the user wants launch resolution/readiness without spawning.
