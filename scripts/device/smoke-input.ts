...
const url = process.env.DEVICE_INPUT_BRIDGE_URL
if (!url) {
  logger.error(
    "DEVICE_INPUT_BRIDGE_URL env var is required (e.g. ws://sm8550:3002)",
  )
  process.exit(2)
}

const timeoutMs = Number.parseInt(
  process.env.DEVICE_INPUT_BRIDGE_TIMEOUT_MS ?? "2000",
  10,
)
